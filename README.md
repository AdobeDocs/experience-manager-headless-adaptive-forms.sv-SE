...
Adobe välkomnar bidrag från communityn och från Adobe anställda utanför dokumentationsteamen.
...
Om du är en del av Adobe-communityn och vill skapa en ny artikel eller föreslå större ändringar öppnar du ett problem på fliken **Problem** i Git-databasen. Då börjar en konversation med dokumentationsteamet. När du har godkänt en plan måste du arbeta tillsammans med en anställd för att få in det nya innehållet genom en kombination av arbete i den offentliga och privata databasen.
...
Tekniska skribenter, programchefer och produktteamutvecklare som skapar eller uppdaterar Experience Cloud tekniska dokument bör använda det privata svaret på `https://git.corp.adobe.com/AdobeDocs`.
...
* [Grunderna för markeringar](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github)
* [Utskrivbart kalkylblad för markering](https://docs.github.com/en)
...
* **ready-to-merge**: Ready for review by Adobe pull request review team.
